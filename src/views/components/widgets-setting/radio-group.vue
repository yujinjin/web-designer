<template>
    <div class="widgets-setting-radio-group">
...
import { type WidgetRadioGroupData, type ChangeSelectedWidgetSettingDataFun } from "@/views/composables/types";
import { usePropNameValidator } from "@/views/composables/validator";
import { useSettingDataValueChange } from "@/views/composables/widgets/radio-group";
...
const props = defineProps({
    settingData: {
        type: Object as PropType<WidgetRadioGroupData["settingData"]>,
        required: true
    }
});
